...
##################
    ...
    output$national_vs <- renderText({if (!is.null(parties())) {parties()[party == 'National', format(v_s, big.mark=',')]}})
    output$national_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'National', sprintf('%0.1f', p)]}})
    output$national_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'National', format(votes_upd, big.mark=',')]}})
    ...
    output$labour_vs <- renderText({if (!is.null(parties())) {parties()[party == 'Labour', format(v_s, big.mark=',')]}})
    output$labour_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'Labour', sprintf('%0.1f', p)]}})
    output$labour_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'Labour', format(votes_upd, big.mark=',')]}})
    ...
    output$green_vs <- renderText({if (!is.null(parties())) {parties()[party == 'Green', format(v_s, big.mark=',')]}})
    output$green_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'Green', sprintf('%0.1f', p)]}})
    output$green_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'Green', format(votes_upd, big.mark=',')]}})
    ...
    output$nzfirst_vs <- renderText({if (!is.null(parties())) {parties()[party == 'NZ First', format(v_s, big.mark=',')]}})
    output$nzfirst_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'NZ First', sprintf('%0.1f', p)]}})
    output$nzfirst_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'NZ First', format(votes_upd, big.mark=',')]}})
    ...
    output$top_vs <- renderText({if (!is.null(parties())) {parties()[party == 'TOP', format(v_s, big.mark=',')]}})
    output$top_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'TOP', sprintf('%0.1f', p)]}})
    output$top_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'TOP', format(votes_upd, big.mark=',')]}})
    ...
    output$maori_vs <- renderText({if (!is.null(parties())) {parties()[party == 'Maori', format(v_s, big.mark=',')]}})
    output$maori_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'Maori', sprintf('%0.1f', p)]}})
    output$maori_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'Maori', format(votes_upd, big.mark=',')]}})
    ...
    output$act_vs <- renderText({if (!is.null(parties())) {parties()[party == 'ACT', format(v_s, big.mark=',')]}})
    output$act_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'ACT', sprintf('%0.1f', p)]}})
    output$act_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'ACT', format(votes_upd, big.mark=',')]}})
    ...
    output$conserv_vs <- renderText({if (!is.null(parties())) {parties()[party == 'Conservative', format(v_s, big.mark=',')]}})
    output$conserv_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'Conservative', sprintf('%0.0f', p)]}})
    output$conserv_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'Conservative', format(votes_upd, big.mark=',')]}})
    ...
    output$ufuture_vs <- renderText({if (!is.null(parties())) {parties()[party == 'United Future', format(v_s, big.mark=',')]}})
    output$ufuture_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'United Future', sprintf('%0.0f', p)]}})
    output$ufuture_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'United Future', format(votes_upd, big.mark=',')]}})
    ...
    output$other_vs <- renderText({if (!is.null(parties())) {parties()[party == 'Other', format(v_s, big.mark=',')]}})
    output$other_pnew <- renderText({if (!is.null(parties())) {parties()[party == 'Other', sprintf('%0.1f', p)]}})
    output$other_vnew <- renderText({if (!is.null(parties())) {parties()[party == 'Other', format(votes_upd, big.mark=',')]}})
